...
function start(){
    ...
    document.querySelector('.scene-final').style.display = '';
    setTimeout(function(){
        document.querySelector('.nastya').classList.add('anim');
    },300);
    setTimeout(function(){
        document.querySelector('div.nastya>p').classList.add('anim');
    },500);
    setTimeout(function(){
        document.querySelector('div.happy').classList.add('anim');
    },1000)
}